    ...
    >
      <View style={styles.container}>
        ...
        >
          ...
          >
            ¿Tomas proteina como suplementacion?
          </Text>
          <Text
            style={{
              ...mediumText,
          ...
          <View style={styles.optionsContainer}>
            <Select
              ...
              label="Sin suplementacion"
              description=""
              setValue={setValue}
              value={value}
              selectValue="notSupplementation"
            ></Select>

            <Select
              style={{ marginBottom: 10 }}
              label="1 scoop al dia (25 a 35g)"
              description=""
              setValue={setValue}
              value={value}
              selectValue="oneScoop"
            ></Select>

            <Select
              style={{ marginBottom: 10 }}
              label="2 scoop al dia (60 a 75g)"
              description=""
              setValue={setValue}
              value={value}
              selectValue="twoScoop"
            ></Select>
          </View>
        </ScrollView>
        <View
        ...
        >
          <TouchableOpacity
            onPress={() =>
              Alert.alert(
                "Desea modifcar el nivel de peso",
                "Este cambio modificara el nivel de peso de los entrenos",
                [
