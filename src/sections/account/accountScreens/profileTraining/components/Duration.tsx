...
const Duration: React.FC = () => {
  ...
  const options = [
    { label: "De 30 a 45 min al dia" },
    { label: "De 1 a 1,5 horas" },
    { label: "Mas de 1,5 horas" },
    { label: "Depende del dias" },
  ];
    ...
    >
      <View style={styles.container}>
        ...
        >
          ...
          >
            ¿Cuanto tiempo quieres entrenar cada dia?
          </Text>
